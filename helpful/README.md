...
## 应用工具类  [ **`HAppUtil`**](https://github.com/Daimhim/vision/tree/master/helpful/src/main/java/org/daimhim/helpful/util/HAppUtil.java)
...
## 日期处理类  [**`HDateUtil`**](https://github.com/Daimhim/vision/tree/master/helpful/src/main/java/org/daimhim/helpful/util/HDateUtil.java)
...
## 文件操作类 [**`HFileUtil`**](https://github.com/Daimhim/vision/tree/master/helpful/src/main/java/org/daimhim/helpful/util/HFileUtil.java)
...
## 图形处理类 [**`HGraphicUtil`**](https://github.com/Daimhim/vision/tree/master/helpful/src/main/java/org/daimhim/helpful/util/HGraphicUtil.java)
...
## 图片处理类 [**`HImageUtil`**](https://github.com/Daimhim/vision/tree/master/helpful/src/main/java/org/daimhim/helpful/util/HImageUtil.java)
...
## 日志工具类 [**`HLogUtil`**](https://github.com/Daimhim/vision/tree/master/helpful/src/main/java/org/daimhim/helpful/util/HLogUtil.java)

## 数学处理类 [**`HMathUtil`**](https://github.com/Daimhim/vision/tree/master/helpful/src/main/java/org/daimhim/helpful/util/HMathUtil.java)
* 四舍五入  `round`
...
## MD5加密 [**`HMd5`**](https://github.com/Daimhim/vision/tree/master/helpful/src/main/java/org/daimhim/helpful/util/HMd5.java)
* MD5加密 `MD5`


## 保存到 SharedPreferences 的数据 [**`HSharedUtil`**](https://github.com/Daimhim/vision/tree/master/helpful/src/main/java/org/daimhim/helpful/util/HSharedUtil.java)

## 字符串处理类 [**`HStrUtil`**](https://github.com/Daimhim/vision/tree/master/helpful/src/main/java/org/daimhim/helpful/util/HStrUtil.java)
...
## View工具类 [**`HViewUtil`**](https://github.com/Daimhim/vision/tree/master/helpful/src/main/java/org/daimhim/helpful/util/HViewUtil.java)
